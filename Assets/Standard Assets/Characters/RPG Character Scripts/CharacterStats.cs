...
public class CharacterStats : MonoBehaviour
{
    ...
    public float m_Level; //character level
    ...
    {
        if(m_BaseStatsModifiersList != null)
        {
        ...
        else if(m_BaseStatsList != null)
        {
            m_Strength = m_BaseStatsList[0];
            m_Dexterity = m_BaseStatsList[1];
            m_Constitution = m_BaseStatsList[2];
            m_Intelligence = m_BaseStatsList[3];
            m_Wisdom = m_BaseStatsList[4];
            m_Charisma = m_BaseStatsList[5];
        }
